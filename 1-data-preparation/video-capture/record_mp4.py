            ...
            if i % 3 == 0:
                ...
                if recording:
                    ...
                    if out is None:
                        ...
                        out = cv2.VideoWriter(filename, fourcc, TARGET_FPS, (x_end - x_start, y_end - y_start))
                        raw_out = cv2.VideoWriter(f"{filename[:-4]}_raw.mp4", fourcc, TARGET_FPS, (1920, 1080))
                ...
                cv2.putText(frame, str(int(i / TARGET_FPS)), (50, 110), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 2, cv2.LINE_AA)
